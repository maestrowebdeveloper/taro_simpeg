...
/**
 * This is the model class for table "{{jabatan_honorer}}".
 *
 * The followings are the available columns in table '{{jabatan_honorer}}':
 * @property integer $id
 ...
 */
class JabatanHonorer extends CActiveRecord
{
	/**
	 ...
	 * @return JabatanHonorer the static model class
	 */
