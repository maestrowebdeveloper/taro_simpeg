...
class LandaProductPhoto extends CWidget {
    ...
    <div class="clearfix">
        <a href="' . $this->model->ProductPhoto->foto['big'] . '" class="jqzoom" rel="gal1"  title="    ' . $this->model->name . '" >
            <img src="' . $this->model->ProductPhoto->foto['big'] . '  "  title="' . $this->model->name . '"  style="border: 4px solid #666; width:100%;">
        </a>
    </div>
	<br/>';
