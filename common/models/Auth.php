    ...
    public function modules($arg = NULL) {
        ...
        return array(
            ...
            array('visible' => landa()->checkAccess('laporanUrutanKepangkatan', 'r'), 'label' => '<span class="icon16  cut-icon-printer-2 "></span>Laporan Pegawai', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                    ...
                    array('visible' => landa()->checkAccess('laporanPerpanjanganHonorer', 'r'), 'label' => '<span class="icon16 icomoon-icon-arrow-right"></span>Perpanjangan Honorer', 'url' => url('/report/perpanjanganHonorer/'), 'auth_id' => 'laporanUnitSatuan'),
                    array('visible' => landa()->checkAccess('laporanMengikutiPelatihan', 'r'), 'label' => '<span class="icon16  icomoon-icon-arrow-right"></span>Mengikuti Pelatihan', 'url' => url('/report/mengikutiPelatihan/'), 'auth_id' => 'laporanPerpanjanganHonorer'),
