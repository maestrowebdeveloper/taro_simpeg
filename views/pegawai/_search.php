    ...
    <tr>
        <td style="vertical-align:top">
            <?php                              
                    ...
                    <div class="controls">
                        <?php echo CHtml::dropDownList('Pegawai[pendidikan_terakhir]', $model->pendidikan_terakhir, Pegawai::model()->arrJenjangPendidikan(), array('class' => 'span2','empty'=>'- Pendidikan -')); ?>
