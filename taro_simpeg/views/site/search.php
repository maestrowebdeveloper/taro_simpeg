...
//                                    'action' => url('bbiiMember/sendEmail'),
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            ...
                                            <div class="input-prepend" style="width: 90%;">
                                                ...
                                                <input class="span12" maxlength="18" style="width:100%" placeholder="Masukan NIP" onKeyup="angka(this);" name="nip" id="nip" type="text" required>
                                            </div>
                                ...
                                <a href="<?php echo url('site/logout') ?>" class="btn btn-primary btn-lg " name="commit" ><i class="icon-remove"></i> Cancel</a>
                                <?php $this->endWidget(); ?>
...
//                    $gaji = RiwayatGaji::model()->findAll(array('condition' => 'pegawai_id=' . $model->id, 'order' => 'tmt_mulai DESC'));
            ...
            ';
                                ...
                                <div class="tab-pane" id="kelauarga">
                                    <table class="table table-bordered">
    <thead>      
        <th>Suami / Istri</th>
        <th>TTL</th>
