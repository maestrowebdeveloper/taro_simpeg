        ...
        <div class="row-fluid">
            <div class="box gradient">
                <div class="content" style="display: block;">
                      <div class="shortcuts">
                        <ul>
                            <li><a style="width:100px" href="<?php echo url('pegawai/ulangTahun')?>?today" title="History Login"><span class="icon24 brocco-icon-calendar "></span><h6>Hari Ini</h6></a></li>
                            <li><a style="width:100px" href="<?php echo url('pegawai/ulangTahun')?>?week" title="History Login"><span class="icon24 icomoon-icon-calendar "></span><h6>Minggu Ini</h6></a></li>
                            <li><a style="width:120px" href="<?php echo url('pegawai/ulangTahun')?>?nextweek" title="History Login"><span class="icon24   iconic-icon-calendar-alt-stroke  "></span><h6>Minggu Depan</h6></a></li>
                            <li><a style="width:100px" href="<?php echo url('pegawai/ulangTahun')?>?month" title="History Login"><span class="icon24 silk-icon-calendar "></span><h6>Bulan Ini</h6></a></li>
                            <li><a style="width:120px" href="<?php echo url('pegawai/ulangTahun')?>?nextmonth" title="History Login"><span class="icon24 minia-icon-calendar  "></span><h6>Bulan Depan</h6></a></li>
                    ...
                    $this->Widget('common.extensions.highcharts.HighchartsWidget', array(
                        'options' => array(
                            'title' => array('text' => 'INFORMASI ULANG TAHUN PEGAWAI'),
                            'xAxis' => array(
