...
$('.search-form form').submit(function(){
    $.fn.yiiGridView.update('hukuman-grid', {
        data: $(this).serialize()
    });
    return false;
});
...
<?php
	$display = (landa()->checkAccess("hukuman","d")==0)?'none':'';
	$button = "";
    if (landa()->checkAccess("hukuman", 'r')) 
        $button .= '{view} ';    
    if (landa()->checkAccess("hukuman", 'u')) 
        $button .= '{update} ';    
    if (landa()->checkAccess("hukuman", 'd')) 
        $button .= '{delete}';    
