<?php
if (isset($_GET['v'])) {$this->setPageTitle('Lihat Jabatan Fungsional Tertentu | ID : '. $model->id);
$this->breadcrumbs=array(
	'Jabatan Fungsional Tertentu'=>array('index'),
	$model->id,
);
}else{$this->setPageTitle('Edit Jabatan Fungsional Tertentu | ID : '. $model->id);
$this->breadcrumbs=array(
	'Jabatan Fungsional Tertentu'=>array('index'),
...
if (isset($_GET['v'])) {
	...
	'items'=>array(
		array('label'=>'Tambah', 'icon'=>'icon-plus', 'url'=>Yii::app()->controller->createUrl('create'), 'linkOptions'=>array(),'visible'=>landa()->checkAccess('jabatabFt', 'c')),
                ...
                array('label'=>'Edit', 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id)), 'linkOptions'=>array(),'visible'=>landa()->checkAccess('jabatabFt', 'u')),
