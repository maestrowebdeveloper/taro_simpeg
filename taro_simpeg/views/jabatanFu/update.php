<?php
if (isset($_GET['v'])) {$this->setPageTitle('Lihat Jabatan Fungsional Umum | ID : '. $model->id);
$this->breadcrumbs=array(
	'Jabatan Fungsional Umum'=>array('index'),
	$model->id,
);
}else{$this->setPageTitle('Edit Jabatan Fungsional Umum | ID : '. $model->id);
$this->breadcrumbs=array(
	'Jabatan Fungsional Umum'=>array('index'),
