...
class KedudukanController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Kedudukan']))
		{
			$model->attributes=$_POST['Kedudukan'];
			if($model->save())
	...
	{        
		...
		{
                        $model->attributes=$_GET['Kedudukan'];
                       ...
                       if (!empty($model->creted_user_id)) $criteria->addCondition('creted_user_id = "'.$model->creted_user_id.'"');
	...
	{
		$model=Kedudukan::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='kedudukan-form')
		{
