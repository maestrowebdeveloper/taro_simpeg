  ...
  public function cssJs() {     
	...
	{        
                ...
                if(isset($_GET['PermohonanMutasi']))
		{
                        ...
                        if($model->new_unit_kerja_id==0)  unset($model->new_unit_kerja_id);                                                
                        if($model->pegawai_id==0)  unset($model->pegawai_id);  
                        if($model->new_jabatan_struktural_id==0)  unset($model->new_jabatan_struktural_id);  
                        if($model->new_jabatan_ft_id==0)  unset($model->new_jabatan_ft_id);  
                        if($model->new_jabatan_fu_id==0)  unset($model->new_jabatan_fu_id);  
