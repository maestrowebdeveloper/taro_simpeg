...
class JabatanFuController extends Controller {
    ...
    public function actionIndex() {
        if (isset($_POST['delete']) && isset($_POST['ceckbox'])) {
            foreach ($_POST['ceckbox'] as $data) {
                $a = JabatanFu::model()->findByPk($data);
                if (!empty($a))
                    $a->deleteNode();
            }
        }
        $criteria = new CDbCriteria();
        $model = new JabatanFu('search');
        $model->unsetAttributes();  // clear any default values

        if (isset($_GET['JabatanFu'])) {
            $model->attributes = $_GET['JabatanFu'];
    ...
    public function loadModel($id) {
        $model = JabatanFu::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'jabatan-fu-form') {
...
//        $session->open();
//
//        if (isset($session['JabatanFu_records'])) {
//            $model = $session['JabatanFu_records'];
//        } else
//            $model = JabatanFu::model()->findAll();
//
//
