        ...
        public function accessRules() {
            return array(
                array('allow', // c
                    ...
                    'expression' => 'app()->controller->isValidAccess("hukuman","c")'
                ),
                array('allow', // r
                    'actions' => array('index', 'view'),
                    'expression' => 'app()->controller->isValidAccess("hukuman","r")'
                ),
                array('allow', // u
                    'actions' => array( 'update'),
                    'expression' => 'app()->controller->isValidAccess("hukuman","u")'
                ),
                array('allow', // d
                    'actions' => array( 'delete'),
                    'expression' => 'app()->controller->isValidAccess("hukuman","d")'
                )
            );
        }
...
//        $session->open();
//
//        if (isset($session['Hukuman_records'])) {
//            $model = $session['Hukuman_records'];
//        } else
