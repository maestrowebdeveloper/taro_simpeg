...
class SiteConfig extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('report_sell,report_retur_sell,format_sell,format_buy,format_other_transaction,
                roles_supplier,roles_vendor,format_reservation,others_include,date_system,settings,
                report_bill,report_bill_charge,report_deposite,format_deposite,format_bill_charge,
                format_report_bill_charge,format_registration,format_bill,
                format_cpns,format_perpanjangan_honorer,format_mutasi,format_pensiun,format_ijin_belajar', 'safe'),
...
//        trace ($this->cache['listSiteConfig']);
    ...
    public function formatting($type, $x = true) {
        ...
        } elseif ($type == 'other_transaction') {
            $textFormat = $siteConfig['format_other_transaction'];
            $lastID = OtherTransaction::model()->find(array('order' => 'id DESC'));
        } elseif ($type == 'bill') {
