...
class Pegawai extends CActiveRecord
{
    ...
    public function arrAgama() {        
        $agama = array('Islam'=>'Islam','Hindu'=>'Hindu','Budha'=>'Budha','Katolik'=>'Katolik','Protestan'=>'Protestan','Konghucu'=>'Konghucu');
        return $agama;
    }
    ...
    public function arrJenjangPendidikan() {        
        $data = array('SD'=>'SD','SMP'=>'SMP','SMA/SMK'=>'SMA/SMK','DIPLOMA'=>'DIPLOMA','SARJANA'=>'SARJANA','MASTER'=>'MASTER','DOCTORATE'=>'DOCTORATE');
        return $data;
    }
