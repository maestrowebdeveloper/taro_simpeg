...
class PermohonanPensiunController extends Controller
{
	...
	{        
                ...
                if(isset($_GET['PermohonanPensiun']))
		{
                       ...
                       if (!empty($model->unit_kerja_id)) $criteria->addCondition('unit_kerja_id = "'.$model->unit_kerja_id.'"');
                     
                    	
                       if (!empty($model->tipe_jabatan)) $criteria->addCondition('tipe_jabatan = "'.$model->tipe_jabatan.'"');
                     
                    	
                       if (!empty($model->jabatan_struktural_id)) $criteria->addCondition('jabatan_struktural_id = "'.$model->jabatan_struktural_id.'"');
                     
                    	
                       if (!empty($model->jabatan_fu_id)) $criteria->addCondition('jabatan_fu_id = "'.$model->jabatan_fu_id.'"');
                     
                    	
                       if (!empty($model->jabatan_ft_id)) $criteria->addCondition('jabatan_ft_id = "'.$model->jabatan_ft_id.'"');
                     
                    	
                       if (!empty($model->masa_kerja)) $criteria->addCondition('masa_kerja = "'.$model->masa_kerja.'"');
...
//        $session->open();
//
//        if (isset($session['PermohonanPensiun_records'])) {
//            $model = $session['PermohonanPensiun_records'];
//        } else
//            $model = PermohonanPensiun::model()->findAll();
//
//
