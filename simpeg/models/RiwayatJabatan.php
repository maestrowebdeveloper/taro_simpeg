...
class RiwayatJabatan extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('tipe_jabatan', 'required'),
            array('bidang_id,type, jabatan_struktural_id, jabatan_fu_id, jabatan_ft_id,tmt_selesai,tanggal_sk_struktural,no_sk_struktural,no_sk_ft,tanggal_sk_ft, created, created_user_id, id, tmt_eselon,tmt_jabatan', 'safe'),
            ...
            // @todo Please removet those attributes that should not be searched.
    ...
    public function relations() {
        ...
        return array(
            ...
            'FT' => array(self::BELONGS_TO, 'JabatanFt', 'jabatan_ft_id'),
