...
$this->widget('bootstrap.widgets.TbMenu', array(
    'type' => 'pills',
    'items' => array(
        array('label' => 'Tambah', 'icon' => 'icon-plus', 'url' => Yii::app()->controller->createUrl('create'), 'linkOptions' => array(),'visible'=>landa()->checkAccess('permohonanMutasi', 'c')),
...
<button type="submit" name="delete" value="dd" style="margin-left: 10px;display:<?php echo $display; ?>" class="btn btn-danger pull-right"><span class="icon16 brocco-icon-trashcan white"></span> Delete Checked</button>
        ...
        <button type="submit" name="otoritasluar" value="dd" style="margin-left: 10px;display:<?php echo $display; ?>" class="btn btn-warning pull-right"><span class="icon16 entypo-icon-publish white"></span> Otoritas Luar Daerah </button>
        <button type="submit" name="otoritasdalam" value="dd" style="margin-left: 10px;display:<?php echo $display; ?>" class="btn btn-success pull-right"><span class="icon16 entypo-icon-publish white"></span> Otoritas Dalam Daerah</button>
