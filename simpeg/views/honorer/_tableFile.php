    ...
    <tbody>
        ...
        foreach ($file as $value) {
            ...
            $action = '<td style="width: 85px;text-align:center">
                        <a class="btn btn-small view" target="_blank" href="'.param('urlImg').'file/honorer/'.$value->pegawai_id."/".$value->nama.'" pegawai="'.$value->pegawai_id.'" id="'.$value->id.'" title="Download File" rel="tooltip" ><i class="icon-file"></i></a>                         
                        '.$del.'
                        </td>';
            echo '
                <tr>                
