...
INNER JOIN jabatan_struktural ON riwayat_jabatan.jabatan_struktural_id = jabatan_struktural.id
INNER JOIN eselon ON jabatan_struktural.eselon_id = eselon.id
WHERE jabatan_struktural.unit_kerja_id = ' . $data->id . ' AND pegawai.kedudukan_id = 1 AND eselon.nama="' . $key . '" AND pegawai.tipe_jabatan="struktural"')->query();
           foreach ($result as $a)
                    $result = $a['result'];
...
INNER JOIN jabatan_struktural ON riwayat_jabatan.jabatan_struktural_id = jabatan_struktural.id
INNER JOIN jabatan_ft ON riwayat_jabatan.jabatan_ft_id = jabatan_ft.id
WHERE jabatan_struktural.unit_kerja_id = ' . $data->id . ' AND pegawai.kedudukan_id = 1 AND jabatan_ft.type="' . $key . '" AND pegawai.tipe_jabatan="fungsional_tertentu"')->query();
