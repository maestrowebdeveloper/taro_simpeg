...
<?php
	$display = (landa()->checkAccess("golongan","d")==0)?'none':'';
	$button = "";
    if (landa()->checkAccess("golongan", 'r')) 
        $button .= '{view} ';    
    if (landa()->checkAccess("golongan", 'u')) 
        $button .= '{update} ';    
    if (landa()->checkAccess("golongan", 'd')) 
        $button .= '{delete}';    
